...
import com.galaxia.mod.machinery.SoundsHandler;
...
public class EntityGalaxiaDragon extends EntityAgeable
{
	public EntityGalaxiaDragon(World worldIn) 
	{
		super(worldIn);
	...
	public EntityAgeable createChild(EntityAgeable ageable) 
	{
		...
		return new EntityGalaxiaDragon(world);
	}
