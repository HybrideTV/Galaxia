...
public class DragoniteHelmet extends ItemArmor {
	public DragoniteHelmet(String name, ArmorMaterial materialIn, int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
	...
	public void onArmorTick(World world, EntityPlayer player, ItemStack itemStack)
	{
		...
		if( player.inventory.armorInventory.get(0) != null && player.inventory.armorInventory.get(1) != null && player.inventory.armorInventory.get(2) != null && player.inventory.armorInventory.get(3) != null )
		{
			...
			if( helmet.getItem() == ItemMod.dragonite_helmet )
			{
